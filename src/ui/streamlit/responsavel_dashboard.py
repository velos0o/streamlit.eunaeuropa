...
class ResponsavelDashboard:
    ...
    def show_upload_instructions():
        ...
        df_exemplo = pd.DataFrame({
            ...
            "Fase": ["REUNIÃO AGENDADA", "EM NEGOCIAÇÃO", "ASSINADO", "ENV. NOVO ADM", "FECHADO"],
    ...
    def calc_metricas_assinatura_fechamento(df):
        ...
        try:
            ...
            # Contar total de ENV. NOVO ADM
            total_env_novo_adm = df[df["Fase"] == "ENV. NOVO ADM"].shape[0]
            ...
            if "FECHADO" in df.columns:
                ...
                df_fechados = df[df["FECHADO"].notna() & (df["FECHADO"] != '') & (df["FECHADO"] != 'nan') & (df["FECHADO"] != 'None')]
                        ...
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <div style="display: flex; align-items: center; justify-content: space-between;">
                                ...
                                <div style="flex: 1; text-align: right; border-left: 1px solid #E8F5E9; padding-left: 1rem;">
                                    <div style="font-size: 0.75rem; color: #2E7D32; margin-bottom: 0.2rem;">Percentual</div>
                                    <div style="font-size: 1.2rem; color: #2E7D32; font-weight: 500;">{metricas_assinatura["percentual_fechados"]}</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    def calc_tempo_medio_fechamento(df):
        ...
        df_fechados = df[df["FECHADO"].notna()].copy()
    ...
    def show_assinatura_fechamento_analysis(df):
        ...
        try:
            ...
            df_env_novo_adm = df[df["Fase"] == "ENV. NOVO ADM"].copy()
            ...
            if len(df_finalizados) == 0:
                st.info("Não foram encontrados negócios nas fases 'ASSINADO' ou 'ENV. NOVO ADM'.")
                return
            ...
            if "FECHADO" in df.columns:
                ...
                df_com_fechamento = df_finalizados[df_finalizados["FECHADO"].notna()].copy()
                df_sem_fechamento = df_finalizados[df_finalizados["FECHADO"].isna()].copy()
            ...
            """, unsafe_allow_html=True)
                ...
                data_tabela = {
                    'Fase': ['Assinados', 'Env. Novo ADM', 'Total'],
